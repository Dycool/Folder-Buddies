...
2. **Firebase Realtime Database** — optional automatic fallback if the public
   Firebase web config is present in `web/config.js` / GitHub Pages variables.
...
quota monitoring, and App Check/auth hardening before real public usage. See `../docs/firebase-fallback.md` for a full setup checklist and stricter rule example.
